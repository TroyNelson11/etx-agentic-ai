...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"TroyNelson11","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'TroyNelson11', repo 'etx-agentic-ai', "
